...
TAXA_DE_ANALISE = 0.80
PLOT_SOMENTE_ULTIMOS_PERIODOS = 150  # Número de períodos para exibir no gráfico final
...
# === 4. Modelo Gradient Boosting Multioutput ===
...
plt.title('Histórico + Projeção Gradient Boosting')
plt.xlabel('Tempo')
plt.ylabel('Valores')
...
# Nome da imagem com data e hora
data_hora_atual = datetime.now().strftime("%Y%m%d_%H%M%S")
nome_arquivo = f"previsao_gb_{data_hora_atual}.png"
...
print("✅ Análise completa com Gradient Boosting gerada com sucesso.")
print("\n📊 Erro MSE por sensor:")
